...
-- MAGIC %python
-- MAGIC spark.sql(f"""
-- MAGIC               CREATE TABLE IF NOT EXISTS f1_delta_presentation.calculated_race_results
-- MAGIC               (
-- MAGIC               race_year INT,
...
-- MAGIC                 FROM f1_delta_processed.results 
-- MAGIC                 JOIN f1_delta_processed.drivers ON (results.driver_id = drivers.driver_id)
-- MAGIC                 JOIN f1_delta_processed.constructors ON (results.constructor_id = constructors.constructor_id)
-- MAGIC                 JOIN f1_delta_processed.races ON (results.race_id = races.race_id)
...
-- MAGIC %python
-- MAGIC spark.sql(f"""
-- MAGIC               MERGE INTO f1_delta_presentation.calculated_race_results tgt
